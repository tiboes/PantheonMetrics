...
public static class GuiLeftBar
{
  ...
  private static bool _isDpsOn = true;
  private static bool _isShowing = true;
  ...
  private static Rect collapsedShowHide = new Rect(_width, _y + 55, _width, _width);
  private static Rect expandedShowHide = new Rect(_width, _y + 55, _width, _width * 20);



  private static ButtonM _onOffButton;
  private static ButtonM _showHideButtonsButton;
  ...
  private static ButtonM _dpsButton;
  ...
  public static void Render()
  {
    ...
    if (_isOn)
    {
      _showHideButtonsButton.Height = _isShowing ? (int)expandedShowHide.height : (int)collapsedShowHide.height;
      _showHideButtonsButton.Render();

      if (_isShowing)
      {
        _dpsButton.SetGUIStyle(GUIGlobals.GetButtonStyle((_isDpsOn ? ButtonStyleEnum.LeftOn : ButtonStyleEnum.LeftOff)));
        _dpsButton.Render();
      }
    }
  ...
  private static void RenderOnOffButton()
  {
    ...
    _onOffButton.SetGUIStyle(GUIGlobals.GetButtonStyle((_isOn ? ButtonStyleEnum.On : ButtonStyleEnum.Off)));
    _onOffButton.Render();    
  }
  ...
  private static void EnsureInitialialization()
  {
    ...
    if (_onOffButton == null)
      _onOffButton = new ButtonM(0, _x, _y + 10, _width*3, _width*3, ToggleOnOff, GUIGlobals.GetButtonStyle((_isOn ? ButtonStyleEnum.On : ButtonStyleEnum.Off)), "", "off");

    if (_dpsButton == null)
      _dpsButton = new ButtonM(0, _x, _y + 10 +  (_width * 3) + 20, _width * 5, _width * 2, ToggleDpsOnOff, GUIGlobals.GetButtonStyle((_isDpsOn ? ButtonStyleEnum.LeftOn : ButtonStyleEnum.LeftOff)), "DPS", "dps");
    if (_showHideButtonsButton == null)
    {
      var rect = _isShowing ? expandedShowHide : collapsedShowHide;
      _showHideButtonsButton = new ButtonM(0, (int)rect.x, (int)rect.y, (int)rect.width, (int)rect.height, ToggleShowHide, GUIGlobals.GetButtonStyle(ButtonStyleEnum.Solid), "", "showHide"); 
    }
  ...
  public static void ResetStyles()
  {
    ...
    if (_showHideButtonsButton != null)
      _showHideButtonsButton.SetGUIStyle(GUIGlobals.GetButtonStyle(ButtonStyleEnum.Solid));
  ...
  public static int ToggleDpsOnOff(int id, string value) 
  { 
    _isDpsOn = !_isDpsOn;
    return 0;
  }

  public static int ToggleShowHide(int id, string value)
  {
