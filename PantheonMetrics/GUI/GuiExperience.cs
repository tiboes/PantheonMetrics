...
public class GuiExperience : GuiTogglePanelBase
{

  public GuiExperience(int x, int y, int width, int height) : base(x, y, width, height)
  { 
  }
  ...
  public override void Render()
  {
    ...
    for (int i = 0; i < lastKillCount; i++)
    {
      ...
      _toggleTogglePanel.AddText(new TextDefinition(killLine, "White", 16));
    }
